...
var player = new function(){
    ...
    this.truck.src = "Image/Truck.png";
    this.rot = 0;
    this.ySpeed = 0;
    this.rSpeed = 0;
    ...
    this.startBtn.src = "Image/Play.png";
    this.leftBtn = new Image();
    this.leftBtn.src = "Image/Left.png";
    this.rightBtn = new Image();
    this.rightBtn.src = "Image/Right.png";
    this.fireBtn = new Image();
    this.fireBtn.src = "Image/Fire.png";
